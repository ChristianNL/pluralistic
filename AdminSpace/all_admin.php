...
<html lang="fr">
    <head>
        ...
        <title>Dashboard - Tous les administrateurs</title>
                            ...
                            <div id="abonnes-table" class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>                                    
                                        ...
                                        $result = $conn -> query("SELECT nom, username, telephone, date_enregistrement from administrateurs");
                                        if ($result -> num_rows > 0) {
                                            while ($row = $result -> fetch_assoc()) {
                                                echo "<tr><td>". $row['nom']. "</td><td>". $row['username']. "</td><td>". 
                                                $row['telephone']. "</td><td>". $row['date_enregistrement']. "</td>";
                                                echo "<td><button onclick='deleteSubscriber(\"" . $row['username'] . "\")'>Supprimer</button></td></tr>";
                                            }
                                            echo "</table>";
                                        } else {
