...
<head>
    ...
    <title>Dashboard - All Realisations</title>
                ...
                <div class="card mb-4">
                    ...
                    <div id="abonnes-table" class="card-body">
                        <table id="datatablesSimple">
                            ...
                            $result = $conn -> query("SELECT video_title, video_path, date_added from video");
                            if ($result -> num_rows > 0) {
                                while ($row = $result -> fetch_assoc()) {
                                    echo "<tr><td>". $row['video_title']. "</td><td>". $row['video_path']. "</td><td>".
                                        $row['date_added']. "</td>";
                                    echo "<td><button onclick='deleteVideo(\"" . $row['video_title'] . "\")'>Supprimer</button></td></tr>";
                                }
                                echo "</table>";
                            } else {
                            ...
                            <script>
                                function deleteVideo(videoTitle) {
                                    if (confirm("Êtes-vous sûr de vouloir supprimer ceci ?")) {
                                        ...
                                        xhr.send("videoTitle=" + videoTitle);
                                    }
                                }
                            </script>
                            </tbody>
